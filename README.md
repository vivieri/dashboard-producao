Dashboard interativo de produção industrial, desenvolvido em Python, usando Streamlit e Plotly, para acompanhamento de métricas de produção, defeitos e scraps em tempo real.
